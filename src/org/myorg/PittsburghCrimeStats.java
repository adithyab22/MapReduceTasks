...
/**
 * MapReduce program to find the number of offense crimes in Pittsburgh
...
public class PittsburghCrimeStats extends Configured implements Tool {
        ...
        public static class WordCountMap extends Mapper<LongWritable, Text, Text, IntWritable>
        {
                ...
                public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException
                {
                       ...
                       String[] lineArray = line.split("\t");
                        if(lineArray!=null){
                        	if(!lineArray[4].contains("Offense")){
                        	word.set(lineArray[4]);
        ...
        public int run(String[] args) throws Exception  {
                ...
                job.setJobName("pittsburghcrimestats");
